                        ...
                        try:
                            ...
                            if ret['ret']:
                                ...
                                try:
                                    ...
                                    print( 'Moving file: ' + lZone + os.path.sep + lteplanfile + ' ---> ' + lZone + os.path.sep + '..' + os.path.sep + '..' + os.path.sep + '..' + os.path.sep + '..' + os.path.sep + 'lteplan' + os.path.sep + 'mover1' + os.path.sep + lteplanfile )
                                    ret = subprocessShellExecute( 'mv -f ' + lZone + os.path.sep + lteplanfile + ' ' + lZone + os.path.sep + '..' + os.path.sep + '..' + os.path.sep + '..' + os.path.sep + '..' + os.path.sep + 'lteplan' + os.path.sep + 'mover1' + os.path.sep + lteplanfile + '.tmp' )
                                    ret = subprocessShellExecute( 'mv -f ' + lZone + os.path.sep + '..' + os.path.sep + '..' + os.path.sep + '..' + os.path.sep + '..' + os.path.sep + 'lteplan' + os.path.sep + 'mover1' + os.path.sep + lteplanfile + '.tmp' + ' ' + lZone + os.path.sep + '..' + os.path.sep + '..' + os.path.sep + '..' + os.path.sep + '..' + os.path.sep + 'lteplan' + os.path.sep + 'mover1' + os.path.sep + lteplanfile )
                                ...
                                val = utilities.dbStatusUpdater( 'update', retToken, fname, recDate[:4] + '-' + recDate[4:6] + '-' + recDate[6:8], 'FAILED', 'Dumping lookup files failed with return code ' + str(retcode) )
