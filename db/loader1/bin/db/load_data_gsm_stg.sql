...
LOAD DATA LOCAL INFILE '/home/imnosrf/ttssinfo/db/loader1/result/S_INFO_GSM.txt' IGNORE INTO TABLE s_info_gsm_stg FIELDS TERMINATED BY '|' ESCAPED BY '' LINES TERMINATED BY '\n'  IGNORE 1 LINES 
