...
load data local infile '/home/imnosrf/ttssinfo/db/loader1/result/S_INFO_UMTS.txt' ignore into table s_info_umts_stg fields terminated by '\t' escaped by '' lines terminated by '\n'  ignore 1 lines
