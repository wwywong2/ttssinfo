...
/*
LOAD DATA LOCAL INFILE '[##DataDir##]/UMTS_GENERAL_INFO.txt' IGNORE INTO TABLE UMTS_GENERAL_INFO FIELDS TERMINATED BY '\t' ESCAPED BY '' LINES TERMINATED BY '\n'  IGNORE 1 LINES
...
*/
LOAD DATA LOCAL INFILE '[##DataDir##]/UMTS_PARAM_2G_NB.txt' IGNORE INTO TABLE UMTS_PARAM_2G_NB FIELDS TERMINATED BY '\t' ESCAPED BY '' LINES TERMINATED BY '\n'  IGNORE 1 LINES
(@COL1,@COL2,@COL3,@COL4,@COL5,@COL6,@COL7)
SET
...
LOAD DATA LOCAL INFILE '[##DataDir##]/UMTS_PARAM_3G_NB.txt' IGNORE INTO TABLE UMTS_PARAM_3G_NB FIELDS TERMINATED BY '\t' ESCAPED BY '' LINES TERMINATED BY '\n'  IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE '[##DataDir##]/UMTS_PARAM_ALU.txt' IGNORE INTO TABLE UMTS_PARAM_ALU FIELDS TERMINATED BY '\t' ESCAPED BY '' LINES TERMINATED BY '\n'  IGNORE 1 LINES
(@COL1,@COL2)
SET
CELL_UID = nullif(@COL1 ,''),
rec_date = nullif(@col2 ,'');

LOAD DATA LOCAL INFILE '[##DataDir##]/UMTS_PARAM_COMMON.txt' IGNORE INTO TABLE UMTS_PARAM_COMMON FIELDS TERMINATED BY '\t' ESCAPED BY '' LINES TERMINATED BY '\n'  IGNORE 1 LINES
(@COL1,@COL2,@COL3)
SET
CELL_UID = nullif(@COL1 ,''),
...
LOAD DATA LOCAL INFILE '[##DataDir##]/UMTS_PARAM_ERICSSON.txt' IGNORE INTO TABLE UMTS_PARAM_ERICSSON FIELDS TERMINATED BY '\t' ESCAPED BY '' LINES TERMINATED BY '\n'  IGNORE 1 LINES
(@COL1,@COL2,@COL3)
SET
CELL_UID = nullif(@COL1 ,''),
...
LOAD DATA LOCAL INFILE '[##DataDir##]/UMTS_PARAM_LUCENT.txt' IGNORE INTO TABLE UMTS_PARAM_LUCENT FIELDS TERMINATED BY '\t' ESCAPED BY '' LINES TERMINATED BY '\n'  IGNORE 1 LINES
(@COL1,@COL2)
SET
CELL_UID = nullif(@COL1 ,''),
rec_date = nullif(@col2 ,'');

LOAD DATA LOCAL INFILE '[##DataDir##]/UMTS_PARAM_NOKIA.txt' IGNORE INTO TABLE UMTS_PARAM_NOKIA FIELDS TERMINATED BY '\t' ESCAPED BY '' LINES TERMINATED BY '\n'  IGNORE 1 LINES
(@COL1,@COL2)
SET
CELL_UID = NULLIF(@COL1 ,''),
rec_date = nullif(@col2 ,'');
...
LOAD DATA LOCAL INFILE '[##DataDir##]/UMTS_STATS.txt' IGNORE INTO TABLE UMTS_STATS FIELDS TERMINATED BY '\t' ESCAPED BY '' LINES TERMINATED BY '\n'  IGNORE 1 LINES
(@COL1,@COL2,@COL3,@COL4)
SET 
TYPE = nullif(@COL1 ,''),
KEY_val = nullif(@COL2 ,''),
...
LOAD DATA LOCAL INFILE '[##DataDir##]/UMTS_TABLE_LIST.txt' IGNORE INTO TABLE UMTS_TABLE_LIST FIELDS TERMINATED BY '\t' ESCAPED BY '' LINES TERMINATED BY '\n'  IGNORE 1 LINES
(@COL1,@COL2,@COL3)
SET 
...
LOAD DATA LOCAL INFILE '[##DataDir##]/UMTS_VERSION.txt' IGNORE INTO TABLE UMTS_VERSION FIELDS TERMINATED BY '\t' ESCAPED BY '' LINES TERMINATED BY '\n'  IGNORE 1 LINES
(@COL1,@COL2,@COL3,@COL4)
...
load data local infile '[##DataDir##]/S_INFO_UMTS.txt' ignore into table s_info_umts fields terminated by '\t' escaped by '' lines terminated by '\n'  ignore 1 lines
...
LOAD DATA LOCAL INFILE '[##DataDir##]/UMTS_PARAM_DAS.txt' IGNORE INTO TABLE UMTS_PARAM_DAS FIELDS TERMINATED BY '\t' ESCAPED BY '' LINES TERMINATED BY '\n'  IGNORE 1 LINES
