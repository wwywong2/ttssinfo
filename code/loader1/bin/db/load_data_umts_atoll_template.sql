...
LOAD DATA LOCAL INFILE '[##DataDir##]/ATOLL_UMTS_EXPORT.csv' IGNORE INTO TABLE SINFO_ATOLL.UMTS_ATOLL_STG FIELDS TERMINATED BY '|' ESCAPED BY '' LINES TERMINATED BY '\r\n'  IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE '[##DataDir##]/S_INFO_UMTS_PARAM_DAS.csv' IGNORE INTO TABLE UMTS_PARAM_DAS FIELDS TERMINATED BY '|' ESCAPED BY '' LINES TERMINATED BY '\r\n'  IGNORE 1 LINES
