...
LOAD DATA LOCAL INFILE '[##DataDir##]/GSM_PARAM_NORTEL_GSMCELL.csv' IGNORE INTO TABLE gsm_param_nortel_gsmcell FIELDS TERMINATED BY '|' ESCAPED BY '' LINES TERMINATED BY '\r\n'  IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE '[##DataDir##]/GSM_PARAM_NORTEL_2G_NB.csv' IGNORE INTO TABLE gsm_param_nortel_2g_nb FIELDS TERMINATED BY '|' ESCAPED BY '' LINES TERMINATED BY '\r\n'  IGNORE 1 LINES
